...
window.SITE = {
  ...
  academic: {
    ...
    blocks: [
      { title:{zh:"全國性藝術評審",en:"National Juror"},
        ...
        img:"ph_studio" },
      { title:{zh:"地方藝術推廣",en:"Regional Advocacy"},
        body:{zh:"參與台中市大墩美展、磺溪美展等地方性藝術活動，提升展覽的專業水準，促進地方藝術文化的繁榮，為在地藝術家創造更多展示與成長的機會。",
              en:"Involved in regional events such as the Dadun and Huangxi Fine Arts Exhibitions — raising professional standards and fostering local artistic culture and opportunity."},
        img:"ph_yiying" },
      { title:{zh:"藝術機構顧問",en:"Museum Advisor"},
